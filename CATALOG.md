...
| [Maui 3D](https://geodata.nzpam.govt.nz/) | New Zealand — offshore Taranaki (Maui field) | 3D post-stack + reprocessed vintages, pre-stack orderable | 10s of GB stack; 100s of GB pre-stack *(est.)* | 🟡 free acct | Open-file under the Crown Minerals Act | COM? | NZP&M order/data-request (login); large 3D shipped on media, not free direct HTTP |
...
| [Parihaka 3D](https://wiki.seg.org/wiki/Parihaka-3D) | New Zealand — offshore Taranaki Basin | 3D post-stack, angle stacks (near/mid/far/full), SEG-Y | ~20.4 GB (4 × 5.1 GB) | 🟢 open | Free; acknowledge NZ Petroleum & Minerals (Crown Minerals) | COM? BY | [huggingface-npy](https://huggingface.co/datasets/SRaha23/parihaka-taranaki/resolve/main/parihaka_seismic.npy) · [nzpm-order](https://geodata.nzpam.govt.nz/) · [dead-s3](http://s3.amazonaws.com/open.source.geoscience/open_data/newzealand/Taranaiki_Basin/PARIHAKA-3D/Parihaka_PSTM_full_angle.sgy) |
| [Waihapa 3D](https://wiki.seg.org/wiki/Waihapa-3D) | New Zealand — onshore Taranaki | 3D post-stack, SEG-Y | ~1–2 GB *(est.)* | 🟡 request | Free; acknowledge NZ Petroleum & Minerals | COM? BY | order free from NZP&M (data-pack); no confirmed direct download |
...
| [WAPIMS (Western Australia DEMIRS)](https://wapims.dmp.wa.gov.au/wapims) | WA onshore and state waters — Carnarvon, Perth, Canning | processed seismic, navigation, scanned sections | ~100s of TB *(est.)* | 🟡 request | Non-commercial use licence (WA DMPE); derived products must be given to the Licensor with attribution | **NC** BY | online Search -> View details -> per-item 'Available for download': reports/metadata direct Download; seismic SEG-Y is Add to Order (basket request) |
| [ANP BDEP / REATE (Brazil)](https://www.gov.br/anp/pt-br/assuntos/exploracao-e-producao-de-oleo-e-gas/dados-tecnicos) | Brazilian basins — Santos, Campos, Equatorial Margin | 2D/3D field and processed, some pre-stack | ~5–7 PB total; 100 TB pre-stack + 37 TB post-stack publicly offered | 🟡 academic | Public data free for universities; fee for industry delivery | **NC** BY | [portal](https://reate.cprm.gov.br/anp/) |
| [ANH EPIS / BIP (Colombia)](https://www2.sgc.gov.co/ProgramasDeInvestigacion/BancoInformacionPetrolera/Paginas/Informacion-General-EPIS.aspx) | Colombia — Llanos, Magdalena, Caribbean offshore | 2D (~150,000 km), 3D (~30,000 km²), pre-stack after confidentiality | ~1.5 PB *(est.)* | 🟡 academic | Free for academia; fee for industry | **NC** BY | [open-data-index](https://www.datos.gov.co/geospatial/Banco-de-Informaci-n-Petrolera-S-smica-3D/m929-qm2x/data) |
...
| [India NDR (DGH)](https://www.dghindia.gov.in/) | Indian basins — KG, Mumbai Offshore | 2D/3D and pre-stack (post-2017) | ~8–10 PB (~2.5 M line-km 2D, ~500,000 km² 3D) *(est.)* | 🟡 academic | Free viewing; fee for download, waived for academia | COM? | register -> GIS view / image previews -> quote/invoice -> data sent (not self-service) |
